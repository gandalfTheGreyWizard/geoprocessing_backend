...
def create_indexes():
    index_spec = { "shapeID": 1 }
    shapeCollection.create_index(index_spec, unique=True)
...
def index_l1():
    ...
    for index, each_record in enumerate(sf.records()):
        ...
        shape_objects_arr.append(temp_dict)
    try:
        shapeCollection.insert_many(shape_objects_arr)
